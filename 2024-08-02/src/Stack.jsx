...
function Stack( {activityRanksIsOpen, setActivityRanksIsOpen, list, setActiveCard, onDrop} ){
    ...
    return (
        <div className={`stack-column ${activityRanksIsOpen ? 'activities-open panel' : 'panel'}`} onClick={togglePanel}>
            <img className="close-icon" src="/src/assets/close.png" height={25}></img>
